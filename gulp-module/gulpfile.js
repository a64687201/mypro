...
//gulp默认命令设置
gulp.task('default', ['lessmin', 'jsmin', 'libsmin', 'htmlmin', 'imagemin','concat']);
//gulp自动监听
gulp.task('watch', function() {
	...
	gulp.watch('src/controller.js', ['concat']); //当controller.js文件发生改变时，调用concat任务
});
//imagemin 图片压缩
...
gulp.task('concat', function() {
	gulp.src(['src/libs/jquery.min.js','src/controller.js'])
